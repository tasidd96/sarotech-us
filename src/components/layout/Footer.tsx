...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/Sarotech.Materiales/",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/sarotech_/",
    icon: (
      <svg width={20} height={20} fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@sarotechh",
    icon: (
      <svg width={20} height={20} fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@SARO-TECH",
    icon: (
      <svg width={20} height={20} fill="currentColor" viewBox="0 0 24 24">
